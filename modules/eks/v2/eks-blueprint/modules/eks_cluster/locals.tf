locals {
  ...
  workload_application = {
    # <-- we could also to blue/green on the workload repo path like: envs/dev-blue / envs/dev-green
    ...
    values = {
      ...
      spec = {
        ...
        # Activate to enable Karpenter manifests (only when Karpenter add-on will be enabled in the Karpenter workshop)
